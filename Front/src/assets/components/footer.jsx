        ...
        <footer id="Contact" className=" shadow-lg  w-full h-10  z-50 mt-auto">
            <div className=" flex items-center relative isolate overflow-hidden h-full bg-white dark:bg-neutral-900 py-16 sm:py-24 lg:py-32">
                <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                    ...
                    <a href="#" className="text-neutral-500 hover:text-indigo-600 duration-200 hover:-translate-y-0.5">
                    ...
                    <p className="mt-8 text-base leading-6 text-center text-neutral-500">
                    © {new Date().getFullYear()} FinTech, Inc. All rights reserved.
                    </p>
                </div>
